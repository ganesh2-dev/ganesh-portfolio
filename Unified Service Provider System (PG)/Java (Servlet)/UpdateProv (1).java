...
@WebServlet("/UpdateProv")

public class UpdateProv extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       String user= (String) session.getAttribute("user");
			    ...
			    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/sample","root","");
                                    ...
                                    PreparedStatement pstmt1 = con.prepareStatement("UPDATE provdetails SET name=?, address=?, area=?, city=?, pincode=?, email=?, phnno=? WHERE provid=?");
