...
@WebServlet("/PlumberRegis")
public class PlumberRegis extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<div class='form-row'>");
             out.println("<div><label for='service'>Service</label><input type='text' name='service' value='Plumber' readonly required /></div>");
