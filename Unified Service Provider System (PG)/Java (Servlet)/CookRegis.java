...
@WebServlet("/CookRegis")
public class CookRegis extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<div class='form-row'>");
             out.println("<div><label for='service'>Service</label><input type='text' name='service' value='Cooking' readonly required /></div>");
            ...
            out.println("<div class='form-row'>");
            out.println("<div><label for='wrktime'>Working time</label><input type='text' name='wrktime' placeholder='hour:min (AM or PM)-hour:min (AM or PM)' required /></div>");
