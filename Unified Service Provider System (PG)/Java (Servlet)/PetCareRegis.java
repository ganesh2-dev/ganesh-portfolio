...
@WebServlet("/PetCareRegis")
public class PetCareRegis extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<div class='form-row'>");
             out.println("<div><label for='service'>Service</label><input type='text' name='service' value='Pet Care' readonly required /></div>");
